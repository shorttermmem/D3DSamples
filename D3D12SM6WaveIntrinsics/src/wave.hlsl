    ...
    switch (renderMode)
    {
        ...
        case 8:
        {
            ...
            uint4 activeLaneMask = WaveActiveBallot(true); /////// a bitmask of the evaluation of the Boolean expression for all active lanes in the current wave. 
                                                           /////// true constant means no divergence.
        ...
        case 9:
        {
            ...
            //  Y
            //
            float dx = QuadReadAcrossX(input.position.x)-input.position.x; /////// 2x2 across X, if I am at (0,0), returns (1,0)
            float dy = QuadReadAcrossY(input.position.y)-input.position.y; /////// 2x2 across Y, if I am at (1,9), returns (1,1)
